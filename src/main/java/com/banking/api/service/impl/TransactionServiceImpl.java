...
public class TransactionServiceImpl implements TransactionService {
        ...
        public TransactionResponse transfer(TransferRequest request, String userId) {
                ...
                BigDecimal fee = feeService.calculateTransferFee(request.getAmount());
                ...
                if (sourceAccount.getBalance().compareTo(totalDebit) < 0) {
                        throw new InsufficientBalanceException(
                                        sourceAccount.getAccountNumber(), totalDebit, sourceAccount.getBalance());
                }

                // Validate transaction limits (may throw if exceeded + creates approval
                // request)
                ...
                // Execute transfer (deduct amount + fee from source, add amount to dest)
                ...
                log.info("Transfer completed: {} → {}, amount: {}, fee: {}, ref: {} [all caches evicted]",
                                sourceAccount.getAccountNumber(), destAccount.getAccountNumber(),
                                request.getAmount(), fee, savedTransaction.getReferenceNumber());
        ...
        public Page<TransactionResponse> searchTransactions(
                ...
                return transactionRepository.findAll(
                                com.banking.api.repository.specification.TransactionSpecification.withFilters(
                                                accountId, type, status, fromDate, toDate, minAmount, maxAmount,
                                                keyword, category),
